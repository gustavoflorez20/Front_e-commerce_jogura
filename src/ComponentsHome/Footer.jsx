      ...
      <div>
        <div className="flex items-center justify-between gap-4 border-b p-8 border-primary">
          ...
          <div className="text-black">
            ...
            <a href="https://api.whatsapp.com/send?phone=34657511851&text=Hola%20%F0%9F%91%8B%20quiero%20hacer%20un%20pedido%20" target="_blank" rel="noopener noreferrer">
            <FaWhatsapp style={{ fontSize: '44px' }} />
</a>     
