  ...
  return (
    <div className='terms'>
      ...
      <p>→ Denominación social: TEQUETAPAS FOODS, S.L. <br />
        ...
        → Sitio Web: http://es.tequetapasfoods.com/</p>  <br /> <br />

      <p>El usuario podrá contactar con el Delegado de Protección de Datos para resolver sus dudas relacionadas con el tratamiento de sus datos personales a la siguiente dirección: [●].</p> <br /> <br />
      ...
      RECOGIDA, FINALIDAD Y TRATAMIENTO DE DATOS <br />

      TEQUETAPAS FOODS ESPAÑA tiene el deber de informar a los usuarios de su sitio web acerca de la recogida de datos de carácter personal que pueda llevarse a cabo, bien mediante el envío de correo electrónico o bien al contactar a través de los formularios de contacto del sitio web. En este sentido, TEQUETAPAS FOODS ESPAÑA será considerado como responsable del tratamiento de los datos recabados mediante los medios anteriormente descritos. <br /> <br />

      Con carácter enunciativo, TEQUETAPAS FOODS ESPAÑA informa que podrá tratar los datos personales de los usuarios para las siguientes finalidades: <br /> <br />
      ...
      • La prestación de servicios. <br /> <br />
